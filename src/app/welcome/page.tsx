            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        ...
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                            <FormControl>
                            <SelectTrigger>
                                <SelectValue placeholder="Select a service or event" />
                            </SelectTrigger>
                            </FormControl>
                            <SelectContent>
                            <SelectItem value="Sunday Service">Sunday Service</SelectItem>
                            <SelectItem value="Tuesday Bible Study">Tuesday Bible Study</SelectItem>
                            </SelectContent>
                        </Select>
                        <FormMessage />
                        </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                    ...
                    <FormLabel>How did you join us?</FormLabel>
                    <FormControl>
                        <RadioGroup
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Your requests are kept confidential.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
